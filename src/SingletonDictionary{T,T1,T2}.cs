...
public sealed partial class SingletonDictionary<T, T1, T2> : ISingletonDictionary<T, T1, T2>
{
    private ConcurrentDictionary<string, T>? _dictionary;
    private readonly AsyncLock _lock;

    private Func<string, CancellationToken, T1, T2, ValueTask<T>>? _asyncKeyTokenFunc;
    private Func<string, CancellationToken, T1, T2, T>? _keyTokenFunc;

    private Func<string, T1, T2, ValueTask<T>>? _asyncKeyFunc;
    private Func<string, T1, T2, T>? _keyFunc;

    private Func<T1, T2, ValueTask<T>>? _asyncFunc;
    private Func<T1, T2, T>? _func;
    ...
    /// </summary>
    public SingletonDictionary(Func<string, T1, T2, ValueTask<T>> func) : this()
    {
        _initializationType = InitializationType.AsyncKey;
        _asyncKeyFunc = func;
    }

    public SingletonDictionary(Func<string, CancellationToken, T1, T2, ValueTask<T>> func) : this()
    {
    ...
    /// If an async initialization func is used, it's recommend that GetSync() NOT be used.
    /// </summary>
    public SingletonDictionary(Func<T1, T2, ValueTask<T>> func) : this()
    {
        _initializationType = InitializationType.Async;
        _asyncFunc = func;
    }

    public SingletonDictionary(Func<string, T1, T2, T> func) : this()
    {
        _initializationType = InitializationType.SyncKey;
        _keyFunc = func;
    }

    public SingletonDictionary(Func<string, CancellationToken, T1, T2, T> func) : this()
    {
        _initializationType = InitializationType.SyncKeyToken;
        _keyTokenFunc = func;
    }

    public SingletonDictionary(Func<T1, T2, T> func) : this()
    {
    ...
    public ValueTask<T> Get(string key, T1 arg1, T2 arg2, CancellationToken cancellationToken = default)
        => GetCore(key, arg1, arg2, cancellationToken);
    ...
    public async ValueTask<T> GetCore(string key, Func<(T1, T2)> argFactory, CancellationToken cancellationToken)
    {
                          ...
                          .NoSync())
        {
            ...
            instance = await GetInternal(key, arg1, arg2, cancellationToken).NoSync();
    ...
    public T GetSync(string key, T1 arg1, T2 arg2, CancellationToken cancellationToken = default)
    {
        ThrowIfDisposed();
    ...
    private ValueTask<T> GetInternal(string key, T1 arg1, T2 arg2, CancellationToken cancellationToken)
    {
        ...
        switch (_initializationType.Value)
        {
            ...
            case InitializationType.SyncValue:
                ...
                return new ValueTask<T>(_func(arg1, arg2));

            case InitializationType.SyncKeyTokenValue:
                if (_keyTokenFunc is null)
                    throw new NullReferenceException("Initialization func for SingletonDictionary cannot be null");

                return new ValueTask<T>(_keyTokenFunc(key, cancellationToken, arg1, arg2));

            case InitializationType.SyncKeyValue:
                if (_keyFunc is null)
                    throw new NullReferenceException("Initialization func for SingletonDictionary cannot be null");

                return new ValueTask<T>(_keyFunc(key, arg1, arg2));
    ...
    private T GetInternalSync(string key, T1 arg1, T2 arg2, CancellationToken cancellationToken)
    {
        if (_initializationType is null)
            throw new InvalidOperationException("Initialization func for SingletonDictionary cannot be null");
        ...
        switch (_initializationType.Value)
        {
            case InitializationType.AsyncKeyValue:
                ...
                return _asyncKeyFunc(key, arg1, arg2).AwaitSync();

            case InitializationType.AsyncKeyTokenValue:
                if (_asyncKeyTokenFunc is null)
                    throw new NullReferenceException("Initialization func for SingletonDictionary cannot be null");

                return _asyncKeyTokenFunc(key, cancellationToken, arg1, arg2).AwaitSync();

            case InitializationType.AsyncValue:
                if (_asyncFunc is null)
                    throw new NullReferenceException("Initialization func for SingletonDictionary cannot be null");

                return _asyncFunc(arg1, arg2).AwaitSync();
    ...
    public void SetInitialization(Func<string, T1, T2, ValueTask<T>> func)
    {
    ...
    public void SetInitialization(Func<string, CancellationToken, T1, T2, ValueTask<T>> func)
    {
        if (_initializationType is not null)
            throw new Exception("Setting the initialization of an SingletonDictionary after it's already has been set is not allowed");
    ...
    public void SetInitialization(Func<T1, T2, ValueTask<T>> func)
    {
        if (_initializationType is not null)
            throw new Exception("Setting the initialization of an SingletonDictionary after it's already has been set is not allowed");
    ...
    public void SetInitialization(Func<T1, T2, T> func)
    {
        if (_initializationType is not null)
            throw new Exception("Setting the initialization of an SingletonDictionary after it's already has been set is not allowed");
    ...
    public void SetInitialization(Func<string, T1, T2, T> func)
    {
        if (_initializationType is not null)
            throw new Exception("Setting the initialization of an SingletonDictionary after it's already has been set is not allowed");
    ...
    public void SetInitialization(Func<string, CancellationToken, T1, T2, T> func)
    {
        if (_initializationType is not null)
            throw new Exception("Setting the initialization of an SingletonDictionary after it's already has been set is not allowed");
    ...
    {
        if (_disposed.Value)
            throw new ObjectDisposedException(nameof(SingletonDictionary<T, T1, T2>));
    }
}
